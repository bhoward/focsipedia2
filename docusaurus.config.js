    ...
    [
      ...
      ({
        docs: {
          ...
          // Note that the edit links point to the .md files generated by mdoc,
          // so you need to replace 'focsipedia-docs/target/mdoc' with 'docs'.
          // editUrl: 'https://github.com/bhoward/focsipedia2/tree/main/',
          editUrl: ({ docPath }) => `https://github.com/bhoward/focsipedia2/edit/main/docs/${docPath}`,
